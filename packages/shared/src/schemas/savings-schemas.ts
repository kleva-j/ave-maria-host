...
export class MakeContributionSchema extends Schema.Class<MakeContributionSchema>(
  ...
  source: PaymentSourceSchema.pipe(
    Schema.annotations({
...
export class UpdatePlanSchema extends Schema.Class<UpdatePlanSchema>(
  ...
  planId: PlanIdSchema,
  planName: Schema.optional(PlanNameSchema),
  autoSaveEnabled: Schema.optional(AutoSaveEnabledSchema),
  autoSaveTime: Schema.optional(AutoSaveTimeSchema),
}) {}
...
export class SavingsPlanSchema extends Schema.Class<SavingsPlanSchema>(
  ...
  currentAmount: Schema.Number,
  autoSaveEnabled: AutoSaveEnabledSchema,
  autoSaveTime: Schema.NullOr(AutoSaveTimeSchema),
