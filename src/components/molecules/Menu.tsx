...
export const labelCss = css(baseItemCss, { color: '$slate11' });
...
StyledMenuCheckboxItem.displayName = 'StyledMenuCheckboxItem';
StyledMenuRadioItem.displayName = 'StyledMenuRadioItem';
